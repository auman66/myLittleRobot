classdef GUI_exported < matlab.apps.AppBase
    ...
    properties (Access = public)
        ...
        ConverttoTDropDownLabel         matlab.ui.control.Label
        ...
        PlotStyleDropDownLabel          matlab.ui.control.Label
        PlotStyleDropDown               matlab.ui.control.DropDown
        GenerateButton                  matlab.ui.control.Button
        ShellDropDown                   matlab.ui.control.DropDown
        ...
        AnimateRobotButton              matlab.ui.control.Button
        GivePosesButton                 matlab.ui.control.Button
        ForwardKinematicsOptionsPanel   matlab.ui.container.Panel
        GridLayout5                     matlab.ui.container.GridLayout
        PathTypeDropDownLabel           matlab.ui.control.Label
        PathTypeDropDown                matlab.ui.control.DropDown
        ...
        DifferentialKinematicsTab       matlab.ui.container.Tab
        TabGroup3                       matlab.ui.container.TabGroup
        ForwardDifferentialKinematicsTab  matlab.ui.container.Tab
        ...
        ConfigurationNumberLabel        matlab.ui.control.Label
        diffConfigNumberEditField       matlab.ui.control.NumericEditField
        ...
        JointConfigurationsPanel_2      matlab.ui.container.Panel
        GridLayout16                    matlab.ui.container.GridLayout
        diffKineConfigTable             matlab.ui.control.Table
        KinematicAnimationsPanel        matlab.ui.container.Panel
        GridLayout18                    matlab.ui.container.GridLayout
        diffAnimateRobotButton          matlab.ui.control.Button
        FindSingularitiesButton         matlab.ui.control.Button
        SingularityTable                matlab.ui.control.Table
        InverseDifferentialKinematicsTab  matlab.ui.container.Tab
        ...
        PoseNumberEditField_2Label_2    matlab.ui.control.Label
        DiffPoseNumberEditField_3       matlab.ui.control.NumericEditField
        FinalTimeEditField_3Label       matlab.ui.control.Label
        FinalTimeEditField_3            matlab.ui.control.NumericEditField
        SampleFrequencyEditField_2Label  matlab.ui.control.Label
        SampleFrequencyEditField_2      matlab.ui.control.NumericEditField
        RobotPosePanel                  matlab.ui.container.Panel
        GridLayout16_2                  matlab.ui.container.GridLayout
        diffKineConfigTable_2           matlab.ui.control.Table
    ...
    methods (Access = private)
        ...
        function populateTableGeometry(app)
            ...
            if app.dropDownGeometry.Value == "DH Parameters"
                ...
                app.EditFieldLabel.Text = "Joint Direction";
                app.EditField2Label.Text = "Link Length";
                app.EditField3Label.Text = "Vertical Offset";
                app.EditField4Label.Text = "Angular Offset";
               if app.dropDownJointType.Value == "Revolute"
                    app.fieldKineThetaOrLength.Editable = 0;
                    app.fieldKineThetaOrLength.FontColor = app.grey; % should be a greyish color
                    app.fieldKineDOrZDir.Editable = 1;
                    ...
                    app.fieldKineDOrZDir.Editable = 1;
                    app.fieldKineDOrZDir.FontColor = app.white;
                    app.fieldKineAOrVertOffset.Editable = 0;
                    app.fieldKineAOrVertOffset.FontColor = app.grey; % should be a greyish color
                    app.fieldJointMin.Value = -5;
                    app.fieldJointMax.Value = 5;
               end
            end
...
%                     T
    ...
    methods (Access = private)
        ...
        function GenerateButtonPushed(app, event)
            ...
            if app.PlotStyleDropDown.Value == "Scatter"
        ...
        % Button pushed function: AnimateRobotButton
        function AnimateRobotButtonPushed(app, event)
        ...
        function GivePosesButtonPushed(app, event)
            ...
            poses = app.robot.fkine(q);
            
            poseMat = reshape(poses,[], 4);
            uitable('Data', poseMat);
        end
...
%                     qf = inv_kin_JacInv(app.robot, pf);
        ...
        % Button pushed function: diffAnimateRobotButton
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.GeometryLabel.Layout.Row = 1;
            ...
            app.dropDownGeometry.Layout.Row = 1;
            ...
            app.JointTypeDropDownLabel.Layout.Row = 2;
            ...
            app.dropDownJointType.Layout.Row = 2;
            ...
            app.GridLayout2.ColumnWidth = {'0.25x', '1x'};
            ...
            % Create ConverttoTDropDownLabel
            app.ConverttoTDropDownLabel = uilabel(app.GridLayout28);
            app.ConverttoTDropDownLabel.HorizontalAlignment = 'right';
            app.ConverttoTDropDownLabel.Layout.Row = 1;
            app.ConverttoTDropDownLabel.Layout.Column = 1;
            app.ConverttoTDropDownLabel.Text = 'Convert to T';
            ...
            app.GridLayout4.RowHeight = {20, 20, 20, 20};

            % Create PlotStyleDropDownLabel
            app.PlotStyleDropDownLabel = uilabel(app.GridLayout4);
            app.PlotStyleDropDownLabel.HorizontalAlignment = 'right';
            app.PlotStyleDropDownLabel.Layout.Row = 1;
            app.PlotStyleDropDownLabel.Layout.Column = 1;
            app.PlotStyleDropDownLabel.Text = 'Plot Style';

            % Create PlotStyleDropDown
            app.PlotStyleDropDown = uidropdown(app.GridLayout4);
            app.PlotStyleDropDown.Items = {'Scatter', 'Polygon'};
            app.PlotStyleDropDown.Layout.Row = 1;
            app.PlotStyleDropDown.Layout.Column = 2;
            app.PlotStyleDropDown.Value = 'Scatter';
            ...
            % Create ShellDropDown
            app.ShellDropDown = uidropdown(app.GridLayout4);
            app.ShellDropDown.Items = {'Point Cloud', 'Shell'};
            app.ShellDropDown.Layout.Row = 2;
            app.ShellDropDown.Layout.Column = 2;
            app.ShellDropDown.Value = 'Point Cloud';
            ...
            app.MeshResolutionEditFieldLabel.Layout.Row = 3;
            ...
            app.MeshResolutionEditField.Layout.Row = 3;
            app.MeshResolutionEditField.Layout.Column = 2;
            app.MeshResolutionEditField.Value = 10;
            ...
            app.TextArea.Value = {'Warning! For robots with large number of joints (n>4) finding workspace with polygon setting can be very resouce intensive. Keep mesh resolution low to avoid issues.'; ''};
            ...
            % Create AnimateRobotButton
            app.AnimateRobotButton = uibutton(app.GridLayout6, 'push');
            app.AnimateRobotButton.ButtonPushedFcn = createCallbackFcn(app, @AnimateRobotButtonPushed, true);
            app.AnimateRobotButton.Layout.Row = 1;
            app.AnimateRobotButton.Layout.Column = 1;
            app.AnimateRobotButton.Text = 'Animate Robot';
            ...
            app.GivePosesButton.Layout.Row = 2;
            app.GivePosesButton.Layout.Column = 1;
            app.GivePosesButton.Text = {'Give Poses'; ''};

            % Create ForwardKinematicsOptionsPanel
            app.ForwardKinematicsOptionsPanel = uipanel(app.GridLayout19);
            ...
            % Create PathTypeDropDownLabel
            app.PathTypeDropDownLabel = uilabel(app.GridLayout5);
            app.PathTypeDropDownLabel.HorizontalAlignment = 'right';
            app.PathTypeDropDownLabel.Layout.Row = 1;
            app.PathTypeDropDownLabel.Layout.Column = 1;
            app.PathTypeDropDownLabel.Text = 'Path Type';

            % Create PathTypeDropDown
            app.PathTypeDropDown = uidropdown(app.GridLayout5);
            app.PathTypeDropDown.Items = {'Once', 'Looping', ''};
            app.PathTypeDropDown.Layout.Row = 1;
            app.PathTypeDropDown.Layout.Column = 2;
            app.PathTypeDropDown.Value = 'Once';
            ...
            app.ConfigurationNumberEditFieldLabel.Layout.Row = 2;
            ...
            app.ConfigurationNumberEditField.Layout.Row = 2;
            ...
            app.TextArea_2.Layout.Row = 2;
            app.TextArea_2.Layout.Column = 2;
            ...
            app.AnimateInvKineButton.Layout.Row = 1;
            ...
            app.AnimateInvKineJacoButton.Layout.Row = 1;
            ...
            app.GiveConfigurationsButton.Layout.Row = 2;
            app.GiveConfigurationsButton.Layout.Column = 1;
            app.GiveConfigurationsButton.Text = {'Give Configurations'; ''};

            % Create InverseKinematicsOptionsPanel
            app.InverseKinematicsOptionsPanel = uipanel(app.GridLayout21);
            ...
            % Create DifferentialKinematicsTab
            app.DifferentialKinematicsTab = uitab(app.tabGroupMain);
            app.DifferentialKinematicsTab.Title = 'Differential Kinematics';

            % Create TabGroup3
            app.TabGroup3 = uitabgroup(app.DifferentialKinematicsTab);
            app.TabGroup3.Position = [1 1 639 391];

            % Create ForwardDifferentialKinematicsTab
            app.ForwardDifferentialKinematicsTab = uitab(app.TabGroup3);
            app.ForwardDifferentialKinematicsTab.Title = 'Forward Differential Kinematics';

            % Create GridLayout15
            app.GridLayout15 = uigridlayout(app.ForwardDifferentialKinematicsTab);

            % Create DifferentialKinematicsOptionsPanel
            app.DifferentialKinematicsOptionsPanel = uipanel(app.GridLayout15);
            app.DifferentialKinematicsOptionsPanel.Title = 'Differential Kinematics Options';
            app.DifferentialKinematicsOptionsPanel.Layout.Row = 1;
            app.DifferentialKinematicsOptionsPanel.Layout.Column = 1;

            % Create GridLayout14
            app.GridLayout14 = uigridlayout(app.DifferentialKinematicsOptionsPanel);
            app.GridLayout14.RowHeight = {'1x', '1x', '1x'};

            % Create ConfigurationNumberLabel
            app.ConfigurationNumberLabel = uilabel(app.GridLayout14);
            app.ConfigurationNumberLabel.HorizontalAlignment = 'right';
            app.ConfigurationNumberLabel.Layout.Row = 1;
            app.ConfigurationNumberLabel.Layout.Column = 1;
            app.ConfigurationNumberLabel.Text = {'Configuration Number'; ''};

            % Create diffConfigNumberEditField
            app.diffConfigNumberEditField = uieditfield(app.GridLayout14, 'numeric');
            app.diffConfigNumberEditField.Limits = [0 20];
            app.diffConfigNumberEditField.RoundFractionalValues = 'on';
            app.diffConfigNumberEditField.Layout.Row = 1;
            app.diffConfigNumberEditField.Layout.Column = 2;
            app.diffConfigNumberEditField.Value = 1;

            % Create FinalTimeEditField_2Label
            app.FinalTimeEditField_2Label = uilabel(app.GridLayout14);
            app.FinalTimeEditField_2Label.HorizontalAlignment = 'right';
            app.FinalTimeEditField_2Label.Layout.Row = 2;
            app.FinalTimeEditField_2Label.Layout.Column = 1;
            app.FinalTimeEditField_2Label.Text = {'Final Time'; ''};

            % Create diffFinalTimeEditField
            app.diffFinalTimeEditField = uieditfield(app.GridLayout14, 'numeric');
            app.diffFinalTimeEditField.Limits = [0 Inf];
            app.diffFinalTimeEditField.Layout.Row = 2;
            app.diffFinalTimeEditField.Layout.Column = 2;
            app.diffFinalTimeEditField.Value = 1;

            % Create SampleFrequencyEditFieldLabel
            app.SampleFrequencyEditFieldLabel = uilabel(app.GridLayout14);
            app.SampleFrequencyEditFieldLabel.HorizontalAlignment = 'right';
            app.SampleFrequencyEditFieldLabel.Layout.Row = 3;
            ...
            app.SampleFrequencyEditField = uieditfield(app.GridLayout14, 'numeric');
            app.SampleFrequencyEditField.Limits = [0.001 Inf];
            app.SampleFrequencyEditField.Layout.Row = 3;
            app.SampleFrequencyEditField.Layout.Column = 2;
            app.SampleFrequencyEditField.Value = 1000;

            % Create JointConfigurationsPanel_2
            app.JointConfigurationsPanel_2 = uipanel(app.GridLayout15);
            app.JointConfigurationsPanel_2.Title = 'Joint Configurations';
            app.JointConfigurationsPanel_2.Layout.Row = 2;
            app.JointConfigurationsPanel_2.Layout.Column = 1;

            % Create GridLayout16
            app.GridLayout16 = uigridlayout(app.JointConfigurationsPanel_2);
            app.GridLayout16.ColumnWidth = {'1x'};
            app.GridLayout16.RowHeight = {'1x'};

            % Create diffKineConfigTable
            app.diffKineConfigTable = uitable(app.GridLayout16);
            app.diffKineConfigTable.ColumnName = {'Column 1'};
            app.diffKineConfigTable.RowName = {};
            app.diffKineConfigTable.Layout.Row = 1;
            app.diffKineConfigTable.Layout.Column = 1;

            % Create KinematicAnimationsPanel
            app.KinematicAnimationsPanel = uipanel(app.GridLayout15);
            app.KinematicAnimationsPanel.Title = 'Kinematic Animations';
            app.KinematicAnimationsPanel.Layout.Row = 1;
            app.KinematicAnimationsPanel.Layout.Column = 2;

            % Create GridLayout18
            app.GridLayout18 = uigridlayout(app.KinematicAnimationsPanel);
            app.GridLayout18.RowHeight = {'1x', '1x', '1x'};

            % Create diffAnimateRobotButton
            app.diffAnimateRobotButton = uibutton(app.GridLayout18, 'push');
            app.diffAnimateRobotButton.ButtonPushedFcn = createCallbackFcn(app, @diffAnimateRobotButtonPushed, true);
            app.diffAnimateRobotButton.Layout.Row = 1;
            app.diffAnimateRobotButton.Layout.Column = 1;
            app.diffAnimateRobotButton.Text = 'Animate Robot';

            % Create FindSingularitiesButton
            app.FindSingularitiesButton = uibutton(app.GridLayout18, 'push');
            app.FindSingularitiesButton.Layout.Row = 1;
            app.FindSingularitiesButton.Layout.Column = 2;
            app.FindSingularitiesButton.Text = 'Find Singularities';

            % Create SingularityTable
            app.SingularityTable = uitable(app.GridLayout15);
            app.SingularityTable.ColumnName = {'Column 1'; 'Column 2'; 'Column 3'; 'Column 4'};
            app.SingularityTable.RowName = {};
            app.SingularityTable.Layout.Row = 2;
            app.SingularityTable.Layout.Column = 2;

            % Create InverseDifferentialKinematicsTab
            app.InverseDifferentialKinematicsTab = uitab(app.TabGroup3);
            app.InverseDifferentialKinematicsTab.Title = 'Inverse Differential Kinematics';

            % Create GridLayout17
            app.GridLayout17 = uigridlayout(app.InverseDifferentialKinematicsTab);

            % Create DifferentialKinematicsOptionsPanel_2
            app.DifferentialKinematicsOptionsPanel_2 = uipanel(app.GridLayout17);
            app.DifferentialKinematicsOptionsPanel_2.Title = 'Differential Kinematics Options';
            app.DifferentialKinematicsOptionsPanel_2.Layout.Row = 1;
            app.DifferentialKinematicsOptionsPanel_2.Layout.Column = 1;

            % Create GridLayout14_2
            app.GridLayout14_2 = uigridlayout(app.DifferentialKinematicsOptionsPanel_2);
            app.GridLayout14_2.RowHeight = {'1x', '1x', '1x'};

            % Create PoseNumberEditField_2Label_2
            app.PoseNumberEditField_2Label_2 = uilabel(app.GridLayout14_2);
            app.PoseNumberEditField_2Label_2.HorizontalAlignment = 'right';
            app.PoseNumberEditField_2Label_2.Layout.Row = 1;
            app.PoseNumberEditField_2Label_2.Layout.Column = 1;
            app.PoseNumberEditField_2Label_2.Text = 'Pose Number';

            % Create DiffPoseNumberEditField_3
            app.DiffPoseNumberEditField_3 = uieditfield(app.GridLayout14_2, 'numeric');
            app.DiffPoseNumberEditField_3.Limits = [0 20];
            app.DiffPoseNumberEditField_3.RoundFractionalValues = 'on';
            app.DiffPoseNumberEditField_3.Layout.Row = 1;
            app.DiffPoseNumberEditField_3.Layout.Column = 2;
            app.DiffPoseNumberEditField_3.Value = 1;

            % Create FinalTimeEditField_3Label
            app.FinalTimeEditField_3Label = uilabel(app.GridLayout14_2);
            app.FinalTimeEditField_3Label.HorizontalAlignment = 'right';
            app.FinalTimeEditField_3Label.Layout.Row = 2;
            app.FinalTimeEditField_3Label.Layout.Column = 1;
            app.FinalTimeEditField_3Label.Text = {'Final Time'; ''};

            % Create FinalTimeEditField_3
            app.FinalTimeEditField_3 = uieditfield(app.GridLayout14_2, 'numeric');
            app.FinalTimeEditField_3.Limits = [0 Inf];
            app.FinalTimeEditField_3.Layout.Row = 2;
            app.FinalTimeEditField_3.Layout.Column = 2;
            app.FinalTimeEditField_3.Value = 1;

            % Create SampleFrequencyEditField_2Label
            app.SampleFrequencyEditField_2Label = uilabel(app.GridLayout14_2);
            app.SampleFrequencyEditField_2Label.HorizontalAlignment = 'right';
            app.SampleFrequencyEditField_2Label.Layout.Row = 3;
            app.SampleFrequencyEditField_2Label.Layout.Column = 1;
            app.SampleFrequencyEditField_2Label.Text = {'Sample Frequency'; ''};

            % Create SampleFrequencyEditField_2
            app.SampleFrequencyEditField_2 = uieditfield(app.GridLayout14_2, 'numeric');
            app.SampleFrequencyEditField_2.Limits = [0.001 Inf];
            app.SampleFrequencyEditField_2.Layout.Row = 3;
            app.SampleFrequencyEditField_2.Layout.Column = 2;
            app.SampleFrequencyEditField_2.Value = 1000;

            % Create RobotPosePanel
            app.RobotPosePanel = uipanel(app.GridLayout17);
            app.RobotPosePanel.Title = 'Robot Pose';
            app.RobotPosePanel.Layout.Row = 2;
            app.RobotPosePanel.Layout.Column = 1;

            % Create GridLayout16_2
            app.GridLayout16_2 = uigridlayout(app.RobotPosePanel);
            app.GridLayout16_2.ColumnWidth = {'1x'};
            app.GridLayout16_2.RowHeight = {'1x'};

            % Create diffKineConfigTable_2
            app.diffKineConfigTable_2 = uitable(app.GridLayout16_2);
            app.diffKineConfigTable_2.ColumnName = {'Column 1'};
            app.diffKineConfigTable_2.RowName = {};
            app.diffKineConfigTable_2.Layout.Row = 1;
            app.diffKineConfigTable_2.Layout.Column = 1;
